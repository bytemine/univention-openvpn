...
function submit_contact_form() {
    ...
    message = document.getElementById("message").value.replace(/\r?\n/g, '%0A');
    if (window.location.href.indexOf("/de/")>-1) {
        body = "Name: "+document.getElementById("name").value+"%0A"
        body += "Telefon: "+document.getElementById("phone").value+"%0A"
        body += "Firma: "+document.getElementById("company").value+"%0A%0A"
        body += "Nachricht:%0A"+message
    } else {
        body = "Name: "+document.getElementById("name").value+"%0A"
        body += "Phone: "+document.getElementById("phone").value+"%0A"
...
function redirect_by_language(langredirects) {
    /*
...
// on mobile devices display tap-to-dial link
$(document).ready(function() {
