...
class univentionOpenVpnIfconfig(simpleHook):
	type = 'univentionOpenVpnSitetoSite'
	delimiter = ': '
	ldapAttribute = 'univentionOpenvpnIfconfig'
	udmAtribute = 'openvpnifconfig'
	...
	def __mapOpenVpnIfconfig(self, module, ml):
	...
	def hook_ldap_addlist(self, module, al=[]):
		al = self.__mapOpenVpnIfconfig(module, al)
		return al
	...
	def hook_ldap_modlist(self, module, ml=[]):
		ml = self.__mapOpenVpnIfconfig(module, ml)
		return ml
